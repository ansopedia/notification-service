# Contributing to Ansopedia Notification Service

Thank you for your interest in contributing to the Ansopedia Notification Service! We appreciate your time and effort to make this project better. Please read the guidelines below to help you get started.
...
Click the fork button in the top right to clone the [Notification Service](https://github.com/ansopedia/notification-service/fork)
...
```bash
git add .
git commit -m "Add new feature for notification registration"
```
